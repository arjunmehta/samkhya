...
var connectionController = {
    ...
    newConnection: function(rawSocket, name) {
        ...
        newConnection.initializer.initialize(initializationMethods, core.opts, initializationDoneClosure(newConnection));
...
function initializationDoneClosure(connection) {
    return function() {
        connection.execute('initialized', 'internal')(true, function(confirmation) {
            ...
            core.emit('initialized', connection, confirmation);
        });
    };
}
