...
Grouping.prototype.addToGroup = function (connID, groupSet, callBack){
  ...
  function _addToGroup(_groupName, _id){
    if(grouping.groups[_groupName] !== undefined && (grouping.groups[_groupName][_id] === undefined || grouping.groups[_groupName][_id] === false)){
      ...
      log.info(process.pid, moduleName, _id, "trying to join Group:", _groupName, ", but it does not exist!");
    }    
  }
