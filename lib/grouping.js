...
Grouping.prototype.createGroup = function (groupName, callBack){
  if(grouping.groups[groupName] === undefined){
    ...
    if(callBack && typeof callBack === "function") callBack("Argyle Error: Group Already Exists", false);
  }
};
...
Grouping.prototype.createNamespace = function(namespace, surfaceToMain){
  ...
  if(argyle.nameSpaces[namespace] === undefined){
    argyle.nameSpaces[namespace] = {};
    if(surfaceToMain === true && argyle[namespace] === undefined){
      argyle[namespace] = argyle.nameSpaces[namespace];
    }
  }
};

Grouping.prototype.removeNamespace = function(namespace){
  if(argyle[namespace] !== undefined && argyle[namespace] === argyle.nameSpaces[namespace]){
    delete argyle[namespace];
  }
  delete argyle.nameSpaces[namespace];
};
...
Grouping.prototype.expose = function(set, ns){
  ...
  if(nameSpace === undefined){
    nameSpace = argyle.nameSpaces[ns] = {};
  }
...
Grouping.prototype.exposeNamespace = function(ns, as){
  if(!argyle.nameSpaces[as]){
    argyle.nameSpaces[as] = ns;
  }
  else{
