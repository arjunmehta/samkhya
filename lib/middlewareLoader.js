...
MiddlewareLoader.prototype.load = function() {
    ...
    for (var i = 0; i < this.initialized_modules.length; i++) {
        this.finalizeModule(this.initialized_modules[i]);
    }
};
...
module.exports = function(samsaara_core, communication_controller, connection_controller, route_controller){
