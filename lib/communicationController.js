...
CommunicationController.prototype.execute = function(executor, func_name, args) {
    ...
    if (typeof args[args.length - 1] === 'function') {
        ...
        this.makeCallBack(args.pop(), [executor.id], packet);
    }
...
module.exports = function(uuid, samsaara_core, connection_controller) {
    return new CommunicationController(uuid, samsaara_core, connection_controller);
};
