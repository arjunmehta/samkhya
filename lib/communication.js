...
communication = (function communication(module){
  ...
  var IncomingCallBack = module.IncomingCallBack = require('../models/callback.js');
  ...
  module.sendToClient = function(connID, packet, theCallBack){
    ...
    // debug(JSON.stringify(makeCallBack));
    ...
    makeCallBack(0, packet, theCallBack, function (callBackID, packetReady){
      ...
      if(connection !== undefined){
        ...
        debug("send To Client", "WRITE FAILED");
      }
    });
  };
  ...
  module.callItBack = nameSpaces.internal.callItBack = function (callBackID, args){
  ...
  module.callItBackError = nameSpaces.internal.callItBackError = function (callBackID, args){
