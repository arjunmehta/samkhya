...
communication = (function communication(module){
  ...
  module.executeFunction = function(connection, messageObj){
    ...
    if(typeof nameSpace[func] === "function"){
      ...
      nameSpace[func].apply(connection, messageArgs);
    }
    else{
  ...
  module.callItBackError = function (callBackID, args){
    ...
    console.log(config.uuid, moduleName, this.id, "CallBack Error Function Handler", callBackID, args);
    var theCallBack = incomingCallBacks[callBackID];
