...
function initialize(samsaaraCore){
  ...
  (function router(module){
    ...
    module.newConnectionMessage = function(connection, message){
      ...
      // Messages come in the format ROUTENAME:(optionalRouteValue):KEYA:ValueA:KEYB:ValueB::{JSONString}
    ...
    var route = module.route = function(connection, headerbits, message){      
