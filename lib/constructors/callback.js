...
function IncomingCallBack(theCallBack, executorArray, destroy) {
    ...
    var isArray = Array.isArray(executorArray);

    this.callbackID = makeUniqueCallBackID();
    this.callBack = theCallBack;
    this.executorList = isArray ? convertToObj(executorArray) : executorArray;
    this.executorCount = isArray ? executorArray.length : Object.keys(this.executorList).length;
