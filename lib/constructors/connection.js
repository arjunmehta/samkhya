...
function Connection(socket, owner, name) {
    ...
    Object.defineProperty(this, 'name', {
        ...
        set: function(newName) {
            connectionController.updateConnectionName(this, _name, newName);
            _name = newName;
        }
    });
...
Connection.prototype.setState = function(state, cb) {
    ...
    this.nameSpace('internal').execute('setState')(state, cb);
};
