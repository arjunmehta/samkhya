...
(function middleware(module){
  ...
  module.initializeModules = function(){
  ...
  var initializeModule = module.initializeModule = function(middleware){
    ...
    if(moduleName){
      ...
      samsaara.capability[moduleName] = true;
    ...
    if(middlewareExports.constructors){
      initializeConstructors(moduleName, middlewareExports.constructors);
    }
  ...
  function initializeConstructors(moduleName, constructors){
    ...
    for(var constructor in constructors){
      samsaara.constructors[constructor] = constructors[constructor];
    }
  }
