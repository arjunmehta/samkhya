...
function addUserSession(userName, password, callBack){
  ...
  samsaara.getFromDB("symphonyusers", userName, function (err, body){
    ...
    if(err){
      ...
      if(match){
        ...
        samsaara.storeToDB("symphonyusers", userName, authentication.userSessions[userID].userData, function (err, reply){
          _evalLoginDB(err, sessionID, userID);
        });
...
function createNewUser(userName, password, email, callBack){
  ...
  samsaara.getFromDB("symphonyusers", userName, function (err, reply){
    if(err){
      samsaara.directStoreToDB("symphonyusers", userName, authentication.userSessions[userID].userData, function (err, reply){
...
function getConnectionSessionInfo(whichOne, callBack){
    ...
    if(callBack && typeof callBack =="function") callBack(sessionID, userID);
}
